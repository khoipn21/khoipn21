...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=C6535D&background=FF000000&center=true&vCenter=true&random=true&width=435&lines=Fullstack+developer+from+Vietnam" alt="Typing SVG" />
</p>
...
![C++](https://shieldcn.dev/badge/C%2B%2B-00599C.svg?logo=cplusplus&logoColor=fff&variant=branded) ![TypeScript](https://shieldcn.dev/badge/TypeScript-3178C6.svg?logo=typescript&logoColor=fff&variant=branded) ![React](https://shieldcn.dev/badge/React-61DAFB.svg?logo=react&logoColor=000&variant=branded) ![Next.js](https://shieldcn.dev/badge/Next.js-000000.svg?logo=nextdotjs&logoColor=fff&variant=branded) ![Tailwind CSS](https://shieldcn.dev/badge/Tailwind%20CSS-06B6D4.svg?logo=tailwindcss&logoColor=fff&variant=branded) ![Bun](https://shieldcn.dev/badge/Bun-000000.svg?logo=bun&logoColor=fff&variant=branded) ![Go](https://shieldcn.dev/badge/Go-00ADD8.svg?logo=go&logoColor=fff&variant=branded) ![Hono](https://shieldcn.dev/badge/Hono-E36002.svg?logo=hono&logoColor=fff&variant=branded) ![PostgreSQL](https://shieldcn.dev/badge/PostgreSQL-4169E1.svg?logo=postgresql&logoColor=fff&variant=branded) ![MySQL](https://shieldcn.dev/badge/MySQL-4479A1.svg?logo=mysql&logoColor=fff&variant=branded) ![MongoDB](https://shieldcn.dev/badge/MongoDB-47A248.svg?logo=mongodb&logoColor=fff&variant=branded) ![Redis](https://shieldcn.dev/badge/Redis-FF4438.svg?logo=redis&logoColor=fff&variant=branded) ![Docker](https://shieldcn.dev/badge/Docker-2496ED.svg?logo=docker&logoColor=fff&variant=branded) ![ESLint](https://shieldcn.dev/badge/ESLint-4B32C3.svg?logo=eslint&logoColor=fff&variant=branded) ![Biome](https://shieldcn.dev/badge/Biome-60A5FA.svg?logo=biome&logoColor=000&variant=branded)
# 📊 GitHub Stats:
